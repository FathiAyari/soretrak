...
class MyRefusedRequests extends StatefulWidget {
  const MyRefusedRequests({Key? key}) : super(key: key);

  @override
  State<MyRefusedRequests> createState() => _MyRefusedRequestsState();
}

class _MyRefusedRequestsState extends State<MyRefusedRequests> {
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text("Pas des demandes en refusé "),
                        ),
                      ],
                    ),
                  ),
